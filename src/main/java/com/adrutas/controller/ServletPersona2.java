...
@WebServlet(name = "ServletPersona", urlPatterns = {"/bbdd/persona2"})
public class ServletPersona2 extends HttpServlet {
	private static final long serialVersionUID = 2876839723003689188L;
...
//    	StringBuffer sB = new StringBuffer("áéíóúÁÉÍÓÚÑñºª");
//        out.println(new Gson().toJson(sB.to));
        out.close();
	}
}